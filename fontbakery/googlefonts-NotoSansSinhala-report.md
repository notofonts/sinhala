...
* ⚠ **WARN** The following spacing glyphs may be in the GDEF mark glyph class by mistake:
	 aivowelsignsinh (U+0DDB), evowelsignsinh (U+0DD9), uni0DDA (U+0DDA), uni0DDC (U+0DDC), uni0DDD (U+0DDD), uni0DDE (U+0DDE) and visargasinh (U+0D83) [code: spacing-mark-glyphs]
...
* ⚠ **WARN** The following non-mark characters should not be in the GDEF mark glyph class:
	 U+0D83, U+0DD9, U+0DDA, U+0DDB, U+0DDC, U+0DDD and U+0DDE [code: non-mark-chars]
...
<pre>Got     : esinh=0+795|rrvocalicvowelsignsinh=0+890|evowelsignsinh=0+0|uni25CC=0+622|oovowelsignaltsinh=0+343|space=3+0|uni0D81=3@0,340+0</pre>
...
Got: <svg class="shaping-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2650 2304" transform="matrix(1 0 0 -1 0 0)">
